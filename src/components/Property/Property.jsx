...
function Property({ property, innerRef }) {
  // const [propertyData, setPropertyData] = useLocalStorage("propertyData", null);
  const featuredPhoto = property.photos.find(
  ...
  return (
    ...
    >
      <div
        className="relative cursor-pointer w-full overflow-hidden transition-all duration-500 ease-in-out h-full"
        ref={innerRef}
      >
        <LazyLoadImage
          effect="blur"
