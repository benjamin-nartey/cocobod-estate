...
const AddPropertyForm = () => {
  ...
  return (
    <div className="w-full p-6 grid place-items-center">
      <Form
        className="bg-white p-6 w-3/5 max-md:w-full"
        form={form}
        layout="vertical"
      ...
      >
        <Divider orientation="left">Property Informations</Divider>
        <Form.Item
          label="Name"
          name="name"
          rules={[
        ...
        <Divider orientation="left">Occupant</Divider>
        ...
        >
          <Input
            name="prevMarketValue"
            value={prevMarketValue}
            onChange={(e) =>
              setformFields({ ...formFields, prevMarketValue: e.target.value })
            }
            type="text"
            placeholder=""
            prefix={<MdOutlineEmail />}
